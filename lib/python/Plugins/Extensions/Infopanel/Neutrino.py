...
class Neutrino(Screen):
	skin = """<screen name="NeutrinoHD2" position="center,center" size="560,400" title="Script Runner" flags="wfBorder" >
		...
		<applet type="onLayoutFinish">
			self["list"].instance.setItemHeight(45)
		</applet>
	</screen>"""
	...
	def __init__(self, session):
		...
		Screen.setTitle(self, _("NeutrinoHD2"))
		self['lab1'] = Label()
		self.list = []
		self.populate_List()
	...
	def runscript(self):
		...
		if self.sel:
			message = _("Are you ready to run NeutrinoHD2 ?")
